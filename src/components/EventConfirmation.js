      ...
      <section className="organiserConfirm">
        <header className="confirm__header">
          <h2 className="confirm__title">
            Let's meet on
            <span>
              {formatDate(createdEvent.event.date_time, "ddd D MMMM YYYY")}
            </span>
            at <span>{formatDate(createdEvent.event.date_time, "h.mm a")}</span>
          </h2>
        </header>

        <section className="confirm__suggestion">
          <h3 className="suggestion__venue">
            <span>Your suggestion</span>
            {createdEvent.suggestions[0].venue_name}
          </h3>

          <h4 className="suggestion__postcode">
            {createdEvent.suggestions[0].postcode}
          </h4>
          ...
          <a
            className="suggestion__sharelink"
            href={urlToShare}
            target="_blank"
