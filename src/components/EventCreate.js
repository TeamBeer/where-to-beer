    ...
    return (
      <section className="organiserSetup">
        ...
        <form onSubmit={this.handleSubmit} className="setupform">
          <div>
            <label className="setupform__namelabel" htmlFor="name">
              Name
            </label>
            <input
              className="setupform__name"
              onChange={this.handleChange}
              type="text"
              name="memberName"
              value={this.state.eventData.memberName}
              pattern="[A-Za-z]{3,}"
              required
            />
          ...
          <div>
            <label className="setupform__datelabel" htmlFor="date">
              Date
            </label>
            <input
              className="setupform__date"
              onChange={this.handleChange}
              type="date"
              name="date"
          ...
          <div>
            <label className="setupform__timelabel" htmlFor="time">
              Time (24hr format)
            </label>
            <input
              className="setupform__time"
              onChange={this.handleChange}
              type="time"
              name="time"
          ...
          <div>
            <label className="setupform__venuelabel" htmlFor="venue_name">
              Pub Name
            </label>
            <input
              className="setupform__venue"
              onChange={this.handleChange}
              type="text"
              name="venueName"
              value={this.state.eventData.venueName}
          ...
          <div>
            <label className="setupform__postcodelabel" htmlFor="postcode">
              Postcode
            </label>
            <input
              className="setupform__postcode"
              onChange={this.handleChange}
              type="text"
              name="venuePostcode"
              value={this.state.eventData.venuePostcode}
              pattern="^([Gg][Ii][Rr]
         0[Aa]{2})|((([A-Za-z][0-9]{1,2})|(([A-Za-z][A-Ha-hJ-Yj-y][0-9]{1,2})|(([AZa-z][0-9][A-Za-z])|([A-Za-z][A-Ha-hJ-Yj-y][0-9]?[A-Za-z]))))\s?[0-9][A-Za-z]{2})$"
          ...
          <div>
            <label className="ssetupform__commentlabel" htmlFor="comment">
              Comment
            </label>
            <textarea
              className="setupform__comment"
              onChange={this.handleChange}
              name="venueReason"
              value={this.state.eventData.venueReason}
            ></textarea>
          </div>
          <div>
