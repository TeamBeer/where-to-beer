      ...
      <React.Fragment>
        <section className="suggestionCreate">
          ...
          <form onSubmit={this.handleSubmit} className="suggestionform">
            <div>
              <label className="suggestionform__venuelabel" htmlFor="venue">
                Pub Name
              </label>
              <input
                onChange={this.handleChange}
                className="suggestionform__venue"
                type="text"
                name="venueName"
                id="venue"
                value={this.state.suggestionData.venueName}
            ...
            <div>
              <label
                className="suggestionform__postcodelabel"
                htmlFor="postcode"
              >
                Postcode
              </label>
              <input
                onChange={this.handleChange}
                className="suggestionform__postcode"
                type="text"
                name="postcode"
                id="postcode"
                value={this.state.suggestionData.postcode}
                pattern="^([Gg][Ii][Rr]
         0[Aa]{2})|((([A-Za-z][0-9]{1,2})|(([A-Za-z][A-Ha-hJ-Yj-y][0-9]{1,2})|(([AZa-z][0-9][A-Za-z])|([A-Za-z][A-Ha-hJ-Yj-y][0-9]?[A-Za-z]))))\s?[0-9][A-Za-z]{2})$"
            ...
            <div>
              <label className="suggestionform__commentlabel" htmlFor="comment">
                Comment
              </label>
              <textarea
                onChange={this.handleChange}
                className="suggestionform__comment"
                name="reason"
                id="comment"
                value={this.state.suggestionData.reason}
              ></textarea>
            </div>
            <div>
              <button className="btn btn__submit" type="submit" value="">
                Submit
              </button>
            </div>
          </form>
